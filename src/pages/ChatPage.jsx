    ...
    try {
      ...
      if (!response.ok) {
        ...
        return `API Error ${response.status}: ${
          errorData.error || "Unknown API error. Check token and model name."
        }`;
      }
    ...
    >
      ...
      >
        ...
        {!HF_TOKEN && (
          ...
          >
            <strong>Error:</strong> HF_TOKEN is missing. Please set
            <code style={{ marginLeft: 6 }}>VITE_HF_TOKEN</code> in your .env and
