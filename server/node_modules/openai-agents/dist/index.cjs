...
const loadToolsDirFunctions = async (dirPath) => {
    try {
        ...
        try {
            await fs__namespace.access(dirPath);
        }
        catch (error) {
        ...
        let files;
        try {
            files = await fs__namespace.readdir(dirPath);
        }
        catch (error) {
 ...
 */
class OpenAIAgent extends OpenAI {
...
exports.getCompletionsUsage = getCompletionsUsage;
